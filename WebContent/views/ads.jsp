	...
	<div class="container-site">
		...
		<div class="sorting">
			<button class="js-sorting sorting-btn" id="bottone-prezzo"
				data-label="Prezzo" data-sorting="prezzo" data-order="asc">Prezzo</button>
			<button class="js-sorting sorting-btn" id="bottone-valutazione"
				data-label="Valutazione" data-sorting="valutazione" data-order="asc">Valutazione</button>
		</div>
	...
	<div id="login-box" class="wrapper">
		<form id="login-form" class="form-signin" action="login" method="post">
			...
			<a><h2 id="exit-button">x</h2></a> <img id="logo-site-login"
				src="/JobAdvisorNew/img/gps.png"> <input id="usernameL"
				type="text" class="form-control" name="username"
				placeholder="Username" required="" autofocus="" /> <input
				id="passwordL" type="password" class="form-control" name="password"
				placeholder="Password" required="" /> <label id="rememberL"
